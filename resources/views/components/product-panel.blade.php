                                ...
                                <div class="col-md-8">
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex border-bottom pb-6 mb-6">
                                            <!-- img -->
                                            <!-- img -->
                                            <img src="./freshcart/images/avatar/avatar-10.jpg" alt="" class="rounded-circle avatar-lg" />
                                            <div class="ms-5">
                                                <h6 class="mb-1">
                                                    Shankar Subbaraman
                                                </h6>
                                                ...
                                                <div>
                                                    <div class="border rounded-3 icon-shape icon-lg border-2">
                                                        <!-- img -->
                                                        <img src="./freshcart/images/products/product-img-1.jpg" alt="" class="img-fluid rounded-3" />
                                                    </div>
                                                    <div class="border rounded-3 icon-shape icon-lg border-2 ms-1">
                                                        <!-- img -->
                                                        <img src="./freshcart/images/products/product-img-2.jpg" alt="" class="img-fluid rounded-3" />
                                                    </div>
                                                    <div class="border rounded-3 icon-shape icon-lg border-2 ms-1">
                                                        <!-- img -->
                                                        <img src="./freshcart/images/products/product-img-3.jpg" alt="" class="img-fluid rounded-3" />
                                                    </div>
                                                </div>
                                                <!-- icon -->
                                        ...
                                        <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                            <!-- img -->
                                            <img src="./freshcart/images/avatar/avatar-12.jpg" alt="" class="rounded-circle avatar-lg" />
                                            <div class="ms-5">
                                                <h6 class="mb-1">
                                                    Robert Thomas
                                                </h6>
                                        ...
                                        <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                            <!-- img -->
                                            <img src="./freshcart/images/avatar/avatar-9.jpg" alt="" class="rounded-circle avatar-lg" />
                                            <div class="ms-5">
                                                <h6 class="mb-1">
                                                    Barbara Tay
                                                </h6>
                                        ...
                                        <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                            <!-- img -->
                                            <img src="./freshcart/images/avatar/avatar-8.jpg" alt="" class="rounded-circle avatar-lg" />
