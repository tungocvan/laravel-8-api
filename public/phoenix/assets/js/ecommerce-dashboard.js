(function(factory) {
    ...
    const newCustomersChartsInit = () => {
        const {
            ...
            getData: o,
            getDates: a
        } = window.phoenix.utils, e = document.querySelector(".echarts-new-customers"), i = t => {
    ...
    const projectionVsActualChartInit = () => {
        const {
            ...
            getData: e,
            getPastDates: o
        } = window.phoenix.utils, a = document.querySelector(".echart-projection-actual"), r = o(10), i = [44485, 20428, 47302, 45180, 31034, 46358, 26581, 36628, 38219, 43256], n = [38911, 29452, 31894, 47876, 31302, 27731, 25490, 30355, 27176, 30393];
        if (a) {
            const o = e(a, "echarts"),
                l = echarts.init(a);
            echartSetOption(l, o, (() => ({
    ...
    const totalSalesChartInit = () => {
        const {
            ...
            getData: o,
            getDates: a
        } = window.phoenix.utils, e = document.querySelector(".echart-total-sales-chart"), i = a(new Date("5/1/2022"), new Date("5/30/2022"), 864e5), n = [100, 200, 300, 300, 300, 250, 200, 200, 200, 200, 200, 500, 500, 500, 600, 700, 800, 900, 1e3, 1100, 850, 600, 600, 600, 400, 200, 200, 300, 300, 300], r = [200, 200, 100, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 200, 400, 600, 600, 600, 800, 1e3, 700, 400, 450, 500, 600, 700, 650, 600, 550], s = t => {
            const o = window.dayjs(t[0].axisValue),
                a = window.dayjs(t[0].axisValue).subtract(1, "month"),
                e = t.map(((t, e) => ({
                    value: t.value,
    ...
    const {
        ...
        const {
            getData: t,
            getColor: e
        } = window.phoenix.utils, o = document.querySelector(".echarts-paying-customer-chart");
        if (o) {
            const r = t(o, "options"),
                i = echarts$1.init(o);
            echartSetOption(i, r, (() => ({
    ...
    const totalOrdersChartInit = () => {
        const {
            ...
            getData: o,
            getDates: r
        } = window.phoenix.utils, a = document.querySelector(".echart-total-orders");
        if (a) {
            const e = o(a, "echarts"),
